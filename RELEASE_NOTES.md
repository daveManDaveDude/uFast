...
**Status:** release candidate; not yet uploaded or submitted  
...
- [ ] Full build, unit, UI, lint and release-verification gates pass.
...
a GitHub release until build 9 is the accepted App Store binary.
